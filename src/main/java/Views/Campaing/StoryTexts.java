...
public class StoryTexts {
    public static String[][] story = {{
        "Você deve estar se perguntando como chegou até aqui, não é?\n" +
        "Um lugar escuro e assustador, sem vida física, apenas mortos e espíritos vagando\n" +
        "por onde der na telha... Bem, antes de mais nada, me diga qual é o seu nome?\n",
        "\nMuito bem %s aqui é o mundo dos mortos e aqui é onde você pagará pelos seus\n" +
        "mais profundos pecados pela eternidade. Porém você está com sorte, você\n" +
        "acaba de conhecer a sua salvação. Sou o Rei do Submundo e lhe trago sua escapatória\n" +
        "Um desafio contra as 8 almas mais fortes desse reino, um jogo de digitação, pegue a sua\n" +
        "máquina de tipografia e venha comigo.",
        "Okay, o jogo se baseia no seguinte: lhe daremos um pequeno texto para você reescrever.\n" +
        "Quanto mais rápido você escrever e se sua escrita tiver poucos erros ortográficos, você\n" +
        "ganhará mais pontos. Isso não é tudo, você estará competindo contra alguém e ele também\n" +
        "terá as mesmas regras que você. Lembre-se, você está no submundo; qualquer artifício é válido\n"+
        "...Vamos testar suas habilidades agora..."
    },{
    ...
    public static String agreement = "Contrato de Prestação de serviços\n" + "\n" +
        "Este artigo deve ser assinado antes da partida começar.\n" +
        "O adversário que perder terá que trabalhar eternamente para o \n" +
        "senhorio deste mundo sem reclamar, chorar, desabafar, lamentar ou\n" +
        "qualquer tipo de resmungo.\n\n" +
        "Penalidades – No caso de descumprimento do contrato, o tal terá que pagar meia\n" + 
        "eternidade de serviços comunitários na terra e no submundo. Caso contrário,\n" + 
        "sua pobre alma será exterminada para toda a existência.\n\n" +
        "Fórum – O Submundo\n\n" + 
        "Hipóteses de Extinção contratual: nenhuma\n\n" +
        "Eu declaro que concordo com os termos deste contrato: ";
}
